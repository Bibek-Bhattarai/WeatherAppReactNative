...
export default class Zip extends Component {
  ...
  componentDidUpdate(prevState) {
    if (this.state.city!== prevState.city) {
      fetch(
        `http://api.openweathermap.org/data/2.5/weather?q=${this.state.city}&APPID=2b522af8a8e662cc2ad7c55054f68e31&units=metric`
      )
        .then(res => res.json())
        .then(json => {
          this.setState({
      ...
      return(
        ...
        return(
          <View>
            ...
            Something went wrong!!!Enter the City name again!!!
            </Text>
          </View>        
        )
      }
